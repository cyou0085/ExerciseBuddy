...
/**
 * Created by carlosyoung on 4/1/15.
 */
...
public class DBAdapterLogin {
    ...
    private static final String DATABASE_NAME = "mydbExerciseBuddyLogin";
    private static  String DATABASE_TABLE = " mylogin";
    ...
    private static final String DATABASE_CREATE =
            "CREATE TABLE " + DATABASE_TABLE + " (id integer primary key autoincrement, "
                    + KEY_EMAIL + " VARCHAR not null," + KEY_PASSWORD + " VARCHAR not null)";
   ...
   /* public long insertRecord(String activity, String day, String sleep, String awake,String am1, String am2)
    ...
    public long insertRecord(String email, String password)
    {
        ContentValues initialValues = new ContentValues();
    ...
    public Cursor getAllRecords()
    {
       // ArrayList<Activity> Activity_aList = new ArrayList<Activity>();
        Cursor c = db.query(DATABASE_TABLE, new String[] {KEY_ROWID, KEY_EMAIL, KEY_PASSWORD}, null, null, null, null,null);
        /*if(c != null){
            if(c.moveToFirst()){
                do{
    ...
    public Cursor getRecord(long rowId) throws SQLException
    {
        ...
        Cursor mCursor =
                db.query(true, DATABASE_TABLE, new String[] {KEY_ROWID, KEY_EMAIL,
                                KEY_PASSWORD},
    ...
    public boolean updateRecord(long rowId, String email,String password)
    {
        ContentValues args = new ContentValues();
